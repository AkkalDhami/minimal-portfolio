...
TV      ───┘
```
<ZoomableImage width="1000" height="400" src="/images/cn.png" alt="Computer Networking" className='h-100 w-auto'/>
---
...
<ZoomableImage width="1000" height="400" src="/images/hiw2.png" wrapperClassName="my-6" alt="Internet Working" className='h-100 w-auto'/>
...
<ZoomableImage width="1000" height="400" src="/images/csa2.png" alt="Client-Server Architecture" className='h-100 w-auto'/>
...
<ZoomableImage width="1000" height="400" src="/images/p2p.png" alt="Peer to Peer Architecture" className='h-100 w-auto'/>
...
<ZoomableImage width="1000" height="400" src="/images/csa.png" alt="Client-Server Architecture" className='h-100 w-auto'/>
...
## <HLink href="/docs/networking/module-01/network-interface-card">7. Network Interface Card (NIC)?</HLink>

A **Network Interface Card (NIC)** is a hardware component that allows a computer to send and receive data over a network.

<ZoomableImage width="600" height="400" src="/images/nic.jpg" alt="Network Interface Card" className='h-100 w-auto'/>
...
## <HLink href="/docs/networking/module-01/mac-address">8. MAC Address</HLink>
...
[Learn More](/docs/networking/module-01/mac-address)

---

## <HLink href="/docs/networking/module-01/ip-address">9. IP Address</HLink>
