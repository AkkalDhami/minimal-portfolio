...
description: Understand how to translate a fuzzy business requirement into a system with defined boundaries, guarantees, and trade-offs, not just a list of technologies.
---
