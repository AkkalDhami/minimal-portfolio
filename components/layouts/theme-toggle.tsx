  ...
  return (
    <>
      <button
        ...
        className={cn(
          "hidden size-8 items-center justify-center rounded-full transition-all duration-300 active:scale-95",
          className
        )}
        onClick={toggleTheme}>
        <svg
      ...
      <Spin toggled={!isDark} onClick={toggleTheme} className={className} />
    </>
  );
};
