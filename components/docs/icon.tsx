...
export const LanguageIcons = {
  ...
  kafka: (props: IconProps) => (
    <svg
      ...
      <g
        ...
        strokeLinejoin="round"
      />
      <g id="apache_kafka_dark__SVGRepo_iconCarrier">
        <g>
  ...
  vercel: (props: IconProps) => (
    <svg {...props} viewBox="0 0 256 222" preserveAspectRatio="xMidYMid">
      <path fill="var(--color-foreground)" d="m128 0 128 221.705H0z" />
    </svg>
  ),
...
export function getIconForLanguageExtension({
  ...
  if (name?.includes("nginx")) {
    return <LanguageIcons.nginx className={cn("size-4", className)} />;
  }
  if (name?.includes("kafka")) {
    return <LanguageIcons.kafka className={cn("size-4", className)} />;
  }
  if (name?.includes("nestjs")) {
    return <LanguageIcons.nestjs className={cn("size-4", className)} />;
  }
  if (name?.includes("vercel")) {
    return <LanguageIcons.vercel className={cn("size-4", className)} />;
  }
