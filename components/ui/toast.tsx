                ...
                <div className="flex gap-2">
                  {Icon && (
                    <div
                      ...
                      <Icon className="in-data-[type=info]:text-info in-data-[type=error]:text-red-600 in-data-[type=loading]:animate-spin in-data-[type=loading]:opacity-80 in-data-[type=success]:text-green-600 in-data-[type=warning]:text-amber-500" />
                    </div>
                  )}
